 ...
 * more than a {@link CameraDetailFragment}.
 */
public class CameraDetailActivity extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
				...
				if (savedInstanceState == null) {
					...
					arguments.putSerializable(CameraDetailFragment.ARG_CONNECTION,
							getIntent().getSerializableExtra(CameraDetailFragment.ARG_CONNECTION));
